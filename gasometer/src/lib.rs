...
impl Inner<'_> {
	...
	/// Valid only after [`GasMetrics::set_calldata_params`] has been called.
	...
	/// Valid only after both [`GasMetrics::set_calldata_params`] and
	/// [`GasMetrics::set_contract_creation`] have been called.
